      ...
      >
        <div
          ...
          style={{
            ...
            width: '160px',
            height: '160px',
            boxShadow: '0 0 40px rgba(198,167,94,0.12), inset 0 0 30px rgba(198,167,94,0.05)',
        ...
        >
          <p
            ...
            style={{ fontSize: '9px', letterSpacing: '0.06em', lineHeight: 1.4 }}
          >
            A Century of
          </p>
          <p
            className="font-serif font-light text-center"
            style={{ fontSize: '7.5px', letterSpacing: '0.05em', color: '#e8e4dc', lineHeight: 1.4 }}
          >
            Trusted Expertise
          </p>

          <div style={{ width: '40px', height: '1px', background: 'rgba(198,167,94,0.3)', margin: '2px 0' }} />
          ...
          <p
            ...
            style={{ fontSize: '6.5px', letterSpacing: '0.15em', color: '#a8a8b0', marginTop: '2px' }}
          >
            EST 1924
          </p>
        </div>
