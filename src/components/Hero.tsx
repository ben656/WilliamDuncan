...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Top right — EST badge circle, starts small, pops into view */}
      <div
      ...
      >
        ...
        >
          <p
            ...
            style={{ fontSize: '12px', letterSpacing: '0.07em', lineHeight: 1.4 }}
          >
            A Century of
          </p>
          <p
            className="font-serif font-light text-center"
            style={{ fontSize: '11px', letterSpacing: '0.05em', color: '#e8e4dc', lineHeight: 1.4 }}
          >
            Trusted Expertise
          </p>
          <div style={{ width: '44px', height: '1px', background: 'linear-gradient(90deg, transparent, rgba(198,167,94,0.5), transparent)', margin: '5px 0' }} />
          <p
            className="font-sans text-center"
            style={{ fontSize: '8px', letterSpacing: '0.25em', color: '#a8a8b0' }}
          >
            EST 1924
          </p>
        </div>
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-8" style={{ paddingTop: '172px' }}>
        ...
        {/* Heading — fades out */}
        <div
          className="flex flex-col items-center text-center absolute inset-0 flex items-center justify-center"
          style={{
            paddingTop: '172px',
        ...
        >
          ...
          <div className="flex flex-col items-center gap-4 text-center w-full max-w-2xl">
            {bullets.map((text, i) => (
              ...
              >
                <span style={{ color: 'rgba(198,167,94,0.6)', fontSize: '10px' }}>◆</span>
                <span
      ...
      {/* Bottom left — Client Access: starts tiny, pops on hover */}
      <div
      ...
      >
        <a
          ...
          style={{
            ...
            borderRadius: '50%',
            width: clientHovered ? '108px' : '40px',
            height: clientHovered ? '108px' : '40px',
            display: 'flex',
            flexDirection: 'column',
            alignItems: 'center',
            justifyContent: 'center',
            gap: clientHovered ? '5px' : '0',
            ...
            boxShadow: clientHovered
              ? '0 0 50px rgba(126,184,212,0.22), 0 0 20px rgba(126,184,212,0.1), inset 0 0 24px rgba(126,184,212,0.07)'
              : '0 0 18px rgba(126,184,212,0.08), inset 0 0 12px rgba(126,184,212,0.03)',
            textDecoration: 'none',
            transition: 'width 0.45s cubic-bezier(0.34,1.56,0.64,1), height 0.45s cubic-bezier(0.34,1.56,0.64,1), border-color 0.3s ease, box-shadow 0.35s ease, background 0.3s ease',
            overflow: 'hidden',
          }}
        >
          <svg
            ...
            strokeWidth={1.5}
            style={{
              width: clientHovered ? '22px' : '16px',
              height: clientHovered ? '22px' : '16px',
          ...
          <span
            style={{
              ...
              overflow: 'hidden',
              transition: 'opacity 0.2s ease 0.15s, max-height 0.3s ease, color 0.3s ease',
            }}
          >
            Client Access
          </span>
      ...
      {/* Bottom right — Enquiries: small arc visible, expands on hover */}
      <div
        className="fixed z-40"
        style={{
          opacity: showCornerElements ? 1 : 0,
      ...
      >
        <div
          ...
          style={{
            ...
            boxShadow: enquiriesHovered
              ? '0 0 100px rgba(198,167,94,0.12), 0 0 40px rgba(198,167,94,0.08), inset 0 0 70px rgba(198,167,94,0.05)'
              : '0 0 60px rgba(198,167,94,0.05), inset 0 0 40px rgba(198,167,94,0.02)',
        ...
        >
          ...
          <div style={{ width: '50px', height: '1px', background: 'linear-gradient(90deg, transparent, rgba(198,167,94,0.4), transparent)', margin: '2px 0' }} />
          ...
          >
            <a
              ...
              title="Email us"
              style={{ color: '#a8a8b0', transition: 'color 0.2s, transform 0.2s' }}
