          ...
          <div className="relative flex items-center justify-center flex-col">
            ...
            >
              ...
              {showMainHeadingPopup && (
                <div className="absolute left-1/2 -translate-x-1/2 top-full mt-8 w-96 max-w-[calc(100vw-3rem)] bg-gradient-to-br from-navy-dark via-navy to-navy-dark backdrop-blur-md border border-gold/50 px-8 py-6 shadow-2xl animate-slide-in z-50">
                  ...
                  <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-px w-0 h-0 border-l-[12px] border-r-[12px] border-b-[12px] border-l-transparent border-r-transparent border-b-gold/50"></div>
