        ...
        >
          <a
            ...
            onMouseEnter={e => {
              ...
              el.style.background = 'rgba(198,167,94,0.14)'
              el.style.borderColor = 'rgba(198,167,94,0.8)'
            }}
            onMouseLeave={e => {
              const el = e.currentTarget as HTMLAnchorElement
              el.style.background = 'rgba(198,167,94,0.06)'
              el.style.borderColor = 'rgba(198,167,94,0.5)'
            }}
          >
            Make an Enquiry
          ...
          <a
            ...
            onMouseEnter={e => {
              const el = e.currentTarget as HTMLAnchorElement
              el.style.background = 'rgba(126,184,212,0.1)'
              el.style.borderColor = 'rgba(126,184,212,0.55)'
            }}
            onMouseLeave={e => {
              const el = e.currentTarget as HTMLAnchorElement
              el.style.background = 'rgba(126,184,212,0.05)'
              el.style.borderColor = 'rgba(126,184,212,0.3)'
            }}
          >
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5}>
