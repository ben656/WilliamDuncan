...
export default function Footer() {
  return (
    <footer className="border-t border-gold/10" style={{ background: 'linear-gradient(to bottom, #1a1814, #111009)' }}>
      ...
      <div className="border-b border-gold/10 flex flex-col items-center justify-center gap-2" style={{ padding: '18px 24px' }}>
      ...
      <div className="max-w-7xl mx-auto px-8 py-4 h-14 flex items-center">
        <div className="flex justify-center items-center gap-5 text-[10px] text-gray-400 w-full">
