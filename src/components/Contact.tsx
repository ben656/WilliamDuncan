    ...
    <section id="contact" className="py-16 sm:py-24" style={{ background: '#080e1a' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-12">
          <div className="rounded-lg overflow-hidden shadow-xl h-52 sm:h-64">
            <iframe
            ...
            <div className="space-y-4">
              <div>
                ...
                <a
                  ...
                  className="font-sans metallic-chrome hover:text-gold transition-colors text-sm break-all"
                >
          ...
          <div className="flex flex-col justify-center">
            <h3 className="font-serif text-xl font-bold metallic-chrome mb-5">
